...
def change_rate(cur_val, last_val):
    ...
    # elif cur_val > last_val: # positive
    #     return (cur_val - last_val) / cur_val * 100
    # elif cur_val < last_val: # negative
    #     return (last_val - cur_val) / cur_val * 100
    # ratio = 712.0
    # if cur_val == last_val: 
    #     return 0.0
    # elif cur_val > last_val: # positive
    #     return (cur_val - last_val) / cur_val * 100 * ratio
    # elif cur_val < last_val: # negative
    #     return (last_val - cur_val) / cur_val * 100 * -1 * ratio
